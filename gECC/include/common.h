...
// Support for blockDim > 65536 using multi-dimensional blocks
__device__ __forceinline__ static u32 block_idx() {
  return blockIdx.x + blockIdx.y * gridDim.x + blockIdx.z * gridDim.x * gridDim.y;
}

__device__ __forceinline__ static u32 block_dim() {
